    ...
    <section className="pt-32 pb-20 px-4 lg:px-8">
      <div className="container mx-auto max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            <h1 className="text-5xl lg:text-7xl font-light tracking-tight mb-6 text-balance">
              Domine IA.
              <br />
              Pense Melhor.
              <br />
          ...
          <ScrollReveal delay={200}>
            <div className="space-y-6">
              ...
              <div className="flex gap-2">
                ...
                <Button className="bg-foreground text-background hover:bg-foreground/90 transition-all duration-300 hover:scale-105">Inscrever-se</Button>
              </div>
